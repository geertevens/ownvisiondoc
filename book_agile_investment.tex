...
\usepackage{graphicx}				% Use pdf, png, jpg, or epsยง with pdflatex; use eps in DVI mode
...
\section{Oneliners}
Scrum is a bouned environment for action (gunther Verheyen)
Als je open bent over je sterktes en je zwaktes dan kun je dingen doen die bij je passen (Hans Duisters)
...
di๋ten maakt dikker (knack juni) : focus op resultaat werkt averechts, focus op omgeving is veel blijvender en duurzamer. 
...
ท         Kenson vervangt Henk nu. Dat is wel een goede evolutie en misschien nieuwe energie.

ท         Programmeren kan iedereen. Software engineering is iets anders

ท         Fit for future idee : aangegeven in kaart brengen van doorlooptijden.

ท         Enige constante in heel de miserie is GL/PL

ท         Tot nog toe sprong ik steeds in een gat. Nu is er geen gat. Blijf wat op mijn honger zitten. Weinig uitdaging.

ท         Als verstoringen weg zijn gaat het opeens veel beter?

ท         Zoveel winst te halen in team ? kwaliteit ? flexibiliteit. Dat moet je door de mensen zelf laten doen.

ท         Dingen laten delegeren en obstacles wegnemen bij personen : testtijd dag later en lijstje Freek verkorten: succesvolle acties

ท         Dingen worden rechtsstreeks bij Edwin aangekaart. Betrokkenheid van het team hierover als vragen komen erg laag. Mijn invloed is erg laag. Ik werk in een andere rol.

ท         Command and control creates followers. 

ท         Podcast : naar achter lopen in standup: mensen moeten naar elkaar vertellen.

ท         Podcast : self-destructing teams: iemand als baas zien en dus problemen doorgeven.

ท         Productief bedrijf investeert in 2 dingen : gouden eieren en welzijn van de gans.

ท         Gunther Verheyen : Wie is hier manager ? => manager van je eigen leven. >>

ท         Hout nodig -> ga hout halen. Was voor boot, dus verkeerd hout, ? . Specifieer waar je het hout voor nodig hebt !

ท         Heel erg sceptisch -> voorzichtig zijn met dingen aan te passen.

ท         Kloof tussen management en werkvolk is nadrukkelijk aanwezig. Weinig betrokkenheid.

ท         Overdreven met complimenten gegooid -> werkt motiverend voor de kinderen. Willen het echt goed doen.

ท          

ท         Precies alsof grootste kind alle speelgoed van de kleinste op de grond gooit en dan roept dat die het moet opruimen omdat het van haar is.

ท         Er zijn er 3 die zich met het proces bezig houden. 

ท         Gevoel van 5de wiel aan de wagen. Edwin en Freek doen nu alle voorbereiding en zit niet veel in voor mij op dit moment.

ท         Krijg hier nu wel het ivoren toren gevoel. Veel voorbesproken tussen Freek en Edwin. 

ท         Amanda Palmer : take all the pain and wear it as a shirt.

ท         Leuk, ik heb bijna de meeste registraties voor mijn presentatie.

ท         Ik moet issues was sneller dingen vlaggen en zien en met mensen praten.

ท         Support met Pieter Custers een hebben over overzichten maken.

 
ท         Support moeten we iets mee doen. -> beter overzicht wat voor issues en mogelijke verbeteracties.

ท         Freek: High level plan statisch. Ik vind dynamisch.

ท         Planning meeting : ging erg rommelig en prioriteit en voorbereiding was dan toch niet in orde.

ท         Complexity los je niet op met complexity.

ท         Agile, my why

ท         Support slorpt toch wel wat tijd op.

ท         Enige constante bij alles wat misgaat is PL en GL. Heel team veranderd op jaar tijd.

ท         Fouad komt binnen en ontgoocheld dat niks ?echt? gedaan is.

ท         5jarige kindjes kunnen hun kleren nog niet goed aandoen, ?

ท         Verbaasd dat zelfs Sioux niet agile doet. 

ท         Toch nog direct taken geven aan teammembers.

ท         Frustratie en ongeloof toch diep bij Freek ook.

ท         http://www.targetprocess.com/articles/speed-in-software-development.html
